...
def overlap_process(event):
    ...
    axes[0].set_title(overlap, fontproperties=fontname)
...
def momentum_process(event):
    ...
    axes[0].plot(middleband, 'b-')
    axes[0].plot(lowerband, 'y-')
    axes[0].set_title(momentum, fontproperties=fontname)
...
def cycle_process(event):
    ...
    axes[0].plot(middleband, 'b-')
    axes[0].plot(lowerband, 'y-')
    axes[0].set_title(cycle, fontproperties=fontname)
...
def statistic_process(event):
    ...
    axes[0].plot(middleband, 'b-')
    axes[0].plot(lowerband, 'y-')
    axes[0].set_title(statistic, fontproperties=fontname)
...
def math_transform_process(event):
    ...
    axes[0].plot(middleband, 'b-')
    axes[0].plot(lowerband, 'y-')
    axes[0].set_title(math_transform, fontproperties=fontname)
...
def math_operator_process(event):
    ...
    axes[0].plot(middleband, 'b-')
    axes[0].plot(lowerband, 'y-')
    axes[0].set_title(math_operator, fontproperties=fontname)
